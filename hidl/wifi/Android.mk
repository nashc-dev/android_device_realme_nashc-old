...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.nashc.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.nashc.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.nashc
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.nashc.rc \
    android.hardware.wifi@1.0-service.nashc.xml
